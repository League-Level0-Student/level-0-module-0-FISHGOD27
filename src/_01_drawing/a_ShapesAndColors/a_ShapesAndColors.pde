...
//    The ellipse command looks like this:      
 ellipse(390, 480, 300,300);
 ellipse(394, 320, 230,230);
 ellipse(394, 180, 170,170);
 fill(#000000);
 ellipse(394, 290, 15, 15);
 ellipse(394, 320, 15, 15);
 ellipse(394, 350, 15, 15);
 ellipse(425, 170, 15, 15);
...
triangle(410,190,393,210,375,190);
